import LiaLogo from './../assests/LM-logo.png';

const Home = () => {
    let sqCss = {'clip-path': 'polygon(0% 100%,100% 100%,0% 0%)'};
    let knitSquareCss = {
      'margin': '0',
    ...
    <nav class="navbar navbar-expand sticky-top navbar-dark bg-dark">
      <div class="container-lg">
        <a class="navbar-brand" href="index.html">
          <img src={LiaLogo} width="30" height="30" class="d-inline-block align-top rounded"
